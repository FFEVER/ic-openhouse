...
class ParticlesSpace extends Component {
  componentDidMount() {
    // Little Canvas things
    var canvas = document.querySelector("#particles-space"),
  ...
  render() {
    return <canvas className={this.props.className} id="particles-space" />;
  }
}
